//week03_6_processing_NS_SHAFT_03_spike_triangl_rolling_frameCount_MOD
//修改自week03_5_processing_NS_SHAFT_02_draw_floor
//小朋友下樓梯 現在加上 上方的尖刺+轉動!
void setup(){
...
void draw (){
    ...
    for(int i=0;i<24;i++){
      ...
      triangle(x,0,x+7,30,x+14,0);//左上、下、右上
    }
}
